...
Функция ДанныеДляПечатиЭтикеток(МассивДокументов) Экспорт
	...
	|	И Номенклатура.Ссылка В(&МассивДокументов)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
    ...
    Представление = Данные.Наименование + ?(ЗначениеЗаполнено(Данные.Артикул), " " + Данные.Артикул,"");
КонецПроцедуры
