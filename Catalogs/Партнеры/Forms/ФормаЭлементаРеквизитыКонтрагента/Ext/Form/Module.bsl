...
Процедура ГруппаСтраницыПриСменеСтраницы(Элемент, ТекущаяСтраница)
	...
	//8/24/2017 2:54:23 PM
	Если ТекущаяСтраница.Имя = "ГруппаДополнительныеРеквизиты" Тогда
		УстановитьДоступностьРедактированияДляДопРеквизитов();
	КонецЕсли;
	//}Кожемякин А.Г.
КонецПроцедуры
...
#КонецОбласти
//Кожемякин А.Г. agkozhemyakin@gmail.com {
//8/24/2017 2:08:19 PM
&НаКлиенте
Процедура УстановитьДоступностьРедактированияДляДопРеквизитов()

	Если дп_ДополнительныеПроцедуры.допРольДоступна("дпРедактироватьСпецУсловияОтгрузки") Тогда//или дп_ДополнительныеПроцедуры.допРольДоступна("ПолныеПрава") Тогда
		Элементы[дп_ДополнительныеПроцедуры.ПолучитьИмяРеквизитаСпецУсловияОтгрузки()].ТолькоПросмотр =  Ложь;
	Иначе
		Элементы[дп_ДополнительныеПроцедуры.ПолучитьИмяРеквизитаСпецУсловияОтгрузки()].ТолькоПросмотр =  Истина;
	КонецЕсли; 
КонецПроцедуры // ()
