...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПримерРасчета = "Если  ТекущаяДата(которая дата и время) + Индивидуальое время в часах > ЖелаемаяДатаОтгрузки, тогда требуется подтверждение" + Символы.ПС + "Пример 13.11.2019 17:32:00 текущая дата,  + 5 часов = не требует.   а + 10 часов = требует подтверждения";
