...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Документы.УстановкаЦенНоменклатурыПоЦеновымГруппам.ИнициализироватьДанныеДокумента(Ссылка, ДополнительныеСвойства);

	ПроведениеСерверУТ.ПодготовитьНаборыЗаписейКРегистрацииДвижений(ЭтотОбъект);

	Ценообразование.ОтразитьЦеныНоменклатуры(ДополнительныеСвойства, Движения, Отказ);

	ОтразитьЦеныЦеновыхГруппНоменклатуры(ДополнительныеСвойства, Движения, Отказ);
	ОтразитьФормулыЦеновыхГруппНоменклатуры(ДополнительныеСвойства, Движения, Отказ);
...
Процедура ОтразитьЦеныЦеновыхГруппНоменклатуры(ДополнительныеСвойства,
	                               Движения,
	                               Отказ) Экспорт
	
	Таблица = ДополнительныеСвойства.ТаблицыДляДвижений.Таблицадп_ЦеныПоЦеновымГруппам;
	...
	ДвиженияЦеныНоменклатуры            = Движения.дп_ЦеныПоЦеновымГруппам;
...
Процедура ОтразитьФормулыЦеновыхГруппНоменклатуры(ДополнительныеСвойства,
	                               Движения,
	                               Отказ) Экспорт
	
	Таблица = ДополнительныеСвойства.ТаблицыДляДвижений.Таблицадп_ФормулыПоЦеновымГруппам;
	...
	ДвиженияЦеныНоменклатуры            = Движения.дп_ФормулыПоЦеновымГруппам;
	ДвиженияЦеныНоменклатуры.Записывать = Истина;
