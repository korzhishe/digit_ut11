...
Процедура ПриОткрытии(Отказ)
	...
	//
	дп_ДополнительныеПроцедурыКлиент.ЗаполнитьКодЦС(Объект,"ВозвращаемыеТовары");
	//}Кожемякин А.Г.
КонецПроцедуры
...
&НаСервере
Процедура РазрешенаПриемкаСкладуПриИзмененииНаСервере()
Объект.РазрешилМенеджер = ПараметрыСеанса.ТекущийПользователь;
КонецПроцедуры

&НаКлиенте
Процедура РазрешенаПриемкаСкладуПриИзменении(Элемент)
	РазрешенаПриемкаСкладуПриИзмененииНаСервере();
КонецПроцедуры
