...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	////ПРФТ +
	//Для каждого текстрока ИЗ Движения.ТоварыОрганизаций Цикл
	//	Если НЕ ЗначениеЗаполнено(ТекСтрока.НомерГТД) Тогда
	//		текстрока.НомерГТД =  Справочники.НомераГТД.НайтиПоКоду("10002010/151216/0070774");
	//	КонецЕсли;
	//КонецЦикла;
	//
	//
	//Для каждого текстрока ИЗ Движения.ТоварыПереданныеНаКомиссию Цикл
	//	Если НЕ ЗначениеЗаполнено(ТекСтрока.НомерГТД) Тогда
	//		текстрока.НомерГТД =  Справочники.НомераГТД.НайтиПоКоду("10002010/151216/0070774");
	//	КонецЕсли;
	//КонецЦикла;
