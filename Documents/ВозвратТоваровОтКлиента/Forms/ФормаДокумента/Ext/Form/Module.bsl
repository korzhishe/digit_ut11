...
Процедура ОбновитьСтатусГИСМ()
	...
	//Кожемякин А.Г. agkozhemyakin@gmail.com {
	//07.03.2017 14:50:51
	//при отркытии формы вываливается ошибка
	Попытка Элементы.ФормаОбщаяКомандаПротоколОбменаГИСМ.Видимость = ВидимостьКомандГИСМ; Исключение КонецПопытки;
	//}Кожемякин А.Г.
