...
// +++
&НаСервере
Процедура ЗаполнитьВидЦеныСебестоимость()
	
	УИД = Новый УникальныйИдентификатор("3c49f578-8848-11e3-9412-4061862b87ca");
	
	Объект.ВидЦены = Справочники.ВидыЦен.ПолучитьСсылку(УИД);
