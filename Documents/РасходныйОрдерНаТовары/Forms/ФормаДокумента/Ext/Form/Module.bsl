...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЕсли;	
	Элементы.ЗаданиеНаПеревозку.Доступность = Объект.ОтгрузкаПоЗаданиюНаПеревозку;	
	//}Кожемякин А.Г.
...
Процедура ПриОткрытии(Отказ)
	...
	//
	дп_ДополнительныеПроцедурыКлиент.ЗаполнитьКодЦС(Объект, "ОтгружаемыеТовары");
	дп_ДополнительныеПроцедурыКлиент.ЗаполнитьКодЦС(Объект, "ТоварыПоРаспоряжениям");
	//}Кожемякин А.Г.
КонецПроцедуры
...
Процедура ЗаполнитьСпецУсловияОтгрузки()
	...
	ДопРеквизитПокупетеля = дп_ДополнительныеПроцедуры.ПолучитьСпецУсловияОтгрузки(Объект.Получатель);
...
&НаКлиенте
Процедура ТоварыПоРаспоряжениямПриИзменении(Элемент)
	ТекущиеДанные = Элементы.ТоварыПоРаспоряжениям.ТекущиеДанные;
	дп_ДополнительныеПроцедурыКлиент.УстановитьКодЦС(ТекущиеДанные);
КонецПроцедуры

&НаКлиенте
Процедура ОтгружаемыеТоварыПриИзменении(Элемент)
	ТекущиеДанные = Элементы.ОтгружаемыеТовары.ТекущиеДанные;
	дп_ДополнительныеПроцедурыКлиент.УстановитьКодЦС(ТекущиеДанные);
КонецПроцедуры
...
Процедура ТипОтгрузкиПриИзмененииНаСервере()
	//Если Объект.Распоряжение.СпособДоставки = Перечисления.СпособыДоставки.ДоКлиента
	//	или Объект.Распоряжение.СпособДоставки = Перечисления.СпособыДоставки.СиламиПеревозчика Тогда
	//    ТипОтгрузки = "ОтгрузкаПоЗаданиюНаПеревозку";
	//	Объект.ОтгрузкаПоЗаданиюНаПеревозку = Истина;
	//Иначе
		//Если ТипОтгрузки = "ОтгрузкаПоЗаданиюНаПеревозку" Тогда
