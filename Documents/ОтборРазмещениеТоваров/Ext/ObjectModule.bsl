...
Процедура РазместитьТовары(ИмяИсточника) Экспорт
	...
	Если ПроверитьЗаполнение() Тогда
		...
		Если Не ОшибкаПроверки Тогда
			...
			// ---
			// +++
			ВыполнитьСортировкуСтрокПоОснованиюПриНеобходимости();
			// CS_Конец	
		КонецЕсли;
	КонецЕсли;
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ПриходныйОрдерНаТовары") Тогда
		...
		// CS_Начало, #68, Алексеев С.В., 15.11.2017
		// ---
		//РазместитьТовары("ТоварыРазмещение");
		// +++
		ВыполнитьСортировкуСтрокПоОснованию(РаспоряжениеСвязка, "Товары", "ТоварыРазмещение");
		// CS_Конец
...
Процедура ВыполнитьСортировкуСтрокПоОснованиюПриНеобходимости()
	...
	Если ЗначениеЗаполнено(РаспоряжениеСвязка) Тогда
		...
		ИмяТЧПриемника = "ТоварыРазмещение";
	ИначеЕсли ТипЗнч(Распоряжение) = Тип("ДокументСсылка.РасходныйОрдерНаТовары") Тогда
		СортировкаНеобходима = Истина;
		
		ДокументОснование = Распоряжение;
		
		ИмяТЧОснования = "ТоварыПоРаспоряжениям";
		
		ИмяТЧПриемника = "ТоварыОтбор";
	КонецЕсли;
