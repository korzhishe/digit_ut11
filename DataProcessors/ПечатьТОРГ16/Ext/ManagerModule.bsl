...
Процедура ЗаполнитьТабличныйДокументТОРГ16(ТабличныйДокумент, ДанныеДляПечати, ОбъектыПечати, ДокументОснование)
	...
	Пока ТабличнаяЧастьВторогоЛиста.Следующий() Цикл
		...
		//21.09.2017 9:19:49
		ОбластьСтрокаВторогоЛиста.Параметры.КодЦС = дп_ДополнительныеПроцедуры.ПолучитьКодЦС(ТабличнаяЧастьВторогоЛиста.Номенклатура, ТабличнаяЧастьВторогоЛиста.Характеристика);			
		//}Кожемякин А.Г.
