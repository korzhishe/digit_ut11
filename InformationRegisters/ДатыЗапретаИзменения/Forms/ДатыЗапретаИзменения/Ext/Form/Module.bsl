...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//ПРФТ++
	//Запрет изменения всем даты редактирования периода!!!!!!!!!!!
	Если ПараметрыСеанса.ТекущийПользователь.Наименование = "ПокровскийС" Тогда
	Иначе
		Попытка
			Сообщить("Периоды ЗАКРЫТЫ. Не нужно ничего редактировать тут :)");
