...
Процедура ПостроитьДеревоЦен(Форма, ИмяТаблицы = "ДеревоЦен") Экспорт
	...
	Для Каждого ВидЦены Из Форма.ВыбранныеЦены Цикл
		...
		Если ВидЦены.Выбрана Или ВидЦены.Влияет Тогда
			...
			ДеревоЗначений.Колонки.Добавить(                          "Распродажа"+ИмяКолонки, Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 2, ДопустимыйЗнак.Неотрицательный)), ВидЦены.Наименование);
			//добавить формулу
			...
			ДеревоЗначений.Колонки.Добавить("ФормулаРаспродажа"				  + ИмяКолонки, Новый ОписаниеТипов("Строка")																   , ВидЦены.Наименование);
			ДеревоЗначений.Колонки.Добавить("СтараяЦенаРаспродажа"            + ИмяКолонки, Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 2, ДопустимыйЗнак.Неотрицательный))  , ВидЦены.Наименование);
			ДеревоЗначений.Колонки.Добавить("ПроцентИзмененияРаспродажа"      + ИмяКолонки, Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(05, 2, ДопустимыйЗнак.Любой)),           ВидЦены.Наименование);
			...
			ДеревоЗначений.Колонки.Добавить("ИзмененаВручнуюРаспродажа"       + ИмяКолонки, Новый ОписаниеТипов("Булево"),                                                                 ВидЦены.Наименование);
			ДеревоЗначений.Колонки.Добавить("ИзмененаАвтоматическиРаспродажа" + ИмяКолонки, Новый ОписаниеТипов("Булево"),                                                                 ВидЦены.Наименование);
	...
	Для Каждого ВидЦены Из Форма.ВыбранныеЦены Цикл
		...
		Если ВидЦены.Выбрана ИЛИ ?(Форма.ОтображатьВлияющиеЦены, ВидЦены.Влияет, Ложь) Тогда
			...
			НоваяГруппа = ДобавитьГруппуФормы(Форма, "ГруппаЦены" + ИмяКолонки, Строка(ВидЦены.Ссылка) + ", " + Строка(ВидЦены.Валюта), Истина, КартинкаШапки, ГруппировкаКолонок.Вертикальная, Неопределено);
			...
			Если ВидЦены.Выбрана Тогда
				...
				НоваяГруппаЦена = ДобавитьГруппуФормы(Форма, "ГруппаЦена" + ИмяКолонки, , Ложь, Неопределено, ГруппировкаКолонок.ВЯчейке, НоваяГруппа);
				
				СтруктураПараметров = Новый Структура();
				СтруктураПараметров.Вставить("Заголовок",              "Формула");
				...
				НоваяГруппаЦенаРаспродажа = ДобавитьГруппуФормы(Форма, "ГруппаЦенаРаспродажа" + ИмяКолонки, , Ложь, Неопределено, ГруппировкаКолонок.ВЯчейке, НоваяГруппа);
				
				СтруктураПараметров = Новый Структура();
				СтруктураПараметров.Вставить("Заголовок",              "Формула распродажа");
				СтруктураПараметров.Вставить("ШиринаПоля",             12);
				СтруктураПараметров.Вставить("ЦветФона",               ЦветФона);
				СтруктураПараметров.Вставить("ЦветФонаЗаголовка",      ЦветЗаголовка);
				СтруктураПараметров.Вставить("Родитель",               НоваяГруппаЦенаРаспродажа);
				СтруктураПараметров.Вставить("ТолькоПросмотрПоля",     Истина);
				
				НовоеПоле = ДобавитьПолеФормы(Форма,"ФормулаРаспродажа" + ИмяКолонки, СтруктураПараметров);
				НовоеПоле.ЦветТекста = WebЦвета.Серый;
				...
				НовоеПоле = ДобавитьПолеФормы(Форма,"СтараяЦенаРаспродажа" + ИмяКолонки, СтруктураПараметров);
				НовоеПоле.ЦветТекста = WebЦвета.Серый;
				...
				НовоеПоле = ДобавитьПолеФормы(Форма,"СуммаИзмененияРаспродажа" + ИмяКолонки, СтруктураПараметров);
				...
				НовоеПоле = ДобавитьПолеФормы(Форма,"ПроцентИзмененияРаспродажа" + ИмяКолонки, СтруктураПараметров);
				НовоеПоле.ЦветТекста = WebЦвета.Серый;
				НовоеПоле.ВыделятьОтрицательные = Истина;
				НовоеПоле.Подсказка = НСтр("ru = 'Процент изменения цены'");
				...
				НовоеПоле                     = Форма.Элементы.Добавить("ДеревоЦен" + "Картинка" + ИмяКолонки, Тип("ПолеФормы"), НоваяГруппаЦена);
				НовоеПоле.ПутьКДанным         = "ДеревоЦен.ИзмененаВручнуюРаспродажа" + ИмяКолонки;
				НовоеПоле.Заголовок           = "";
				НовоеПоле.РежимРедактирования = РежимРедактированияКолонки.ВходПриВводе;
				НовоеПоле.Вид                 = ВидПоляФормы.ПолеКартинки;
				НовоеПоле.ТолькоПросмотр      = Истина;
				...
				СтруктураПараметров = Новый Структура();
				СтруктураПараметров.Вставить("Заголовок",              НСтр("ru='Цена распродажа'"));
				СтруктураПараметров.Вставить("ОбработчикПриИзменении", "Подключаемый_ДеревоЦенЦенаПриИзменении");
				СтруктураПараметров.Вставить("ШиринаПоля",             12);
				СтруктураПараметров.Вставить("ЦветФона",               ЦветФона);
				СтруктураПараметров.Вставить("ЦветФонаЗаголовка",      ЦветЗаголовка);
				...
				НовоеПоле = ДобавитьПолеФормы(Форма, "Распродажа"+ИмяКолонки, СтруктураПараметров);
			Иначе
...
Функция СоздатьТаблицуТовары(ЭтоРегистрацияЦенПоставщика) Экспорт
	...
	ТаблицаЗначений.Колонки.Добавить("ЦенаРаспродажа",         Новый ОписаниеТипов("Число"));
	ТаблицаЗначений.Колонки.Добавить("Формула",         Новый ОписаниеТипов("Строка"));
	ТаблицаЗначений.Колонки.Добавить("ФормулаРаспродажа",         Новый ОписаниеТипов("Строка"));
...
Процедура ПеречитатьВыбранныеЦены(Форма) Экспорт
	...
	ВидыЦен = УстановкаЦенПоЦеновымГруппамКлиентСервер.ВыбранныеВидыЦен(Форма);
...
Функция ДобавитьТоварыПредприятия(Форма, Знач ТаблицаТовары, КэшДанных) Экспорт
	...
	|	&Таблица КАК Таблица
	|ГДЕ
	|	Таблица.ЦеноваяГруппа <> ЗНАЧЕНИЕ(Справочник.ЦеновыеГруппы.ПустаяСсылка)
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	ЦеноваяГруппа
	|;
	|
	|ВЫБРАТЬ
	|	ТаблицаНоменклатура.ЦеноваяГруппа.Наименование     КАК Наименование,
	|	ТаблицаНоменклатура.ЦеноваяГруппа                  КАК ЦеноваяГруппа,
	...
	Запрос.УстановитьПараметр("ВидыЦен",       УстановкаЦенПоЦеновымГруппамКлиентСервер.ВыбранныеВидыЦен(Форма));
	...
	Пока ВыборкаНоменклатура.Следующий() Цикл
		...
		ПараметрыОтбора = Новый Структура("ЦеноваяГруппа", ВыборкаНоменклатура.ЦеноваяГруппа);
		...
		Иначе
			...
			УстановкаЦенПоЦеновымГруппамКлиентСервер.ЗаполнитьИндексКартинкиСтрокиДереваЦен(ЭлементНоменклатура);
		...
		//				УстановкаЦенПоЦеновымГруппамКлиентСервер.ЗаполнитьИндексКартинкиСтрокиДереваЦен(ЭлементХарактеристика);
		//				
		//				НоваяСтрокаТЗ = КэшДанных.ТаблицаСоответствияНоменклатурыСтрокамДереваТоваров.Добавить();
...
Функция ДобавитьТоварыПоОтбору(Форма,
	...
	Если НЕ ЭтоРегистрацияЦенПоставщика
		...
		СтруктураПараметров = Новый Структура();
		СтруктураПараметров.Вставить("МассивСтрокВидовЦен", УстановкаЦенПоЦеновымГруппамКлиентСервер.ВыбранныеСтрокиТаблицыВидовЦен(Форма));
...
Функция РассчитатьЦеныПоИдентификаторуСтроки(Форма,
	...
	ТаблицаНоменклатуры = СоздатьТаблицуНоменклатуры();
	ЗаполнитьЗначенияСвойств(ТаблицаНоменклатуры.Добавить(), СтрокаТаблицыЦен, "ЦеноваяГруппа");
...
Функция РассчитатьЦены(Форма, ПараметрыРасчета, КэшДанных = Неопределено) Экспорт
	...
	Для Каждого ВидЦены Из ПараметрыРасчета.ВидыЦен Цикл
		МассивВидовЦен.Добавить(УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВидаЦен(Форма.ВыбранныеЦены, ВидЦены));
	КонецЦикла;
...
Процедура РассчитатьВычисляемыеЦены(Форма,
	...
	Если ВидыЦен = Неопределено Тогда
		Если ИзмененноеПоле = Неопределено Тогда
			ВидыЦен = УстановкаЦенПоЦеновымГруппамКлиентСервер.ВыбранныеСтрокиТаблицыВидовЦен(Форма);
		Иначе
			СтрокаИзмененныйВидЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.СтрокаВидаЦеныПоИмениПоля(Форма.ВыбранныеЦены, ИзмененноеПоле);
				...
				Если ТекущаяЦена = 0 Или Не ТолькоНезаполненные Тогда
					...
					Если ЗначениеЗаполнено(Формула) Тогда
						...
						Для Каждого БазоваяЦена Из ВидЦены.ВлияющиеЦены Цикл
							...
							СтрокаБазовойЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВидаЦен(Форма.ВыбранныеЦены, БазоваяЦена.Значение);
							
							СтрокаПересчетаВалюты   = УстановкаЦенПоЦеновымГруппамКлиентСервер.СтрокаПересчетаВалюты(СтрокаБазовойЦены.Валюта, ВидЦены.Валюта, КэшДанных.КурсыВалют);
							Если Форма.ИспользоватьУпаковкиНоменклатуры Тогда
								СтрокаПересчетаУпаковок = УстановкаЦенПоЦеновымГруппамКлиентСервер.СтрокаПересчетаУпаковок(СтрокаТаблицыЦен, СтрокаБазовойЦены, ВидЦены, ТаблицаКоэффициентовУпаковокНоменклатуры);
							Иначе
						...
						Попытка
							...
							ЗначениеЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.ОкруглитьЦену(Вычислить(Формула), ВидЦены);
...
Функция ИзменитьЦеныНаПроцент(Форма, ПараметрыРасчета, КэшДанных = Неопределено) Экспорт
	...
	Для Каждого СтрокаМассива Из ПараметрыРасчета.ВидыЦен Цикл
		ВидыЦен.Добавить(УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВидаЦен(Форма.ВыбранныеЦены, СтрокаМассива.ВидЦены));
	КонецЦикла;
	...
	Если Не ПараметрыРасчета.ТолькоВыделенныеСтроки Тогда
		...
		Для Каждого СтрокаМассива Из ПараметрыРасчета.ВидыЦен Цикл
			...
			Для Каждого ЭлементНоменклатура Из ЭлементыНоменклатура Цикл
				...
				Если ЭлементНоменклатура["СтараяЦенаРаспродажа"+ИмяКолонки] <> 0 Тогда
					
					Если ПараметрыРасчета.ИзменятьПоОтношениюКСтаройЦене Тогда
						ЭлементНоменклатура["ПроцентИзмененияРаспродажа" + ИмяКолонки] = СтрокаМассива.ПроцентИзменения;
						ЭлементНоменклатура[ИмяКолонки] = Окр(ЭлементНоменклатура["СтараяЦенаРаспродажа"+ИмяКолонки]*((ЭлементНоменклатура["ПроцентИзмененияРаспродажа"+ИмяКолонки]/100)+1), 2);
					Иначе
						ЭлементНоменклатура[ИмяКолонки] = Окр(ЭлементНоменклатура[ИмяКолонки]*((СтрокаМассива.ПроцентИзменения/100)+1), 2);
						ЭлементНоменклатура["ПроцентИзмененияРаспродажа" + ИмяКолонки] = (ЭлементНоменклатура[ИмяКолонки] / ЭлементНоменклатура["СтараяЦенаРаспродажа" + ИмяКолонки] - 1) * 100; 
					КонецЕсли;
					
				Иначе
					
					ЭлементНоменклатура["ПроцентИзмененияРаспродажа" + ИмяКолонки] = 0;
					Если ПараметрыРасчета.ИзменятьПоОтношениюКСтаройЦене Тогда
						ЭлементНоменклатура[ИмяКолонки] = 0;
					Иначе
						ЭлементНоменклатура[ИмяКолонки] = Окр(ЭлементНоменклатура[ИмяКолонки]*((СтрокаМассива.ПроцентИзменения/100)+1), 2);
				...
				ЭлементНоменклатура["ИзмененаВручнуюРаспродажа" + ИмяКолонки] = Истина;
				ЭлементНоменклатура["ИзмененаАвтоматическиРаспродажа" + ИмяКолонки] = Ложь;
	...
	Иначе
		...
		Для Каждого СтрокаМассива Из ПараметрыРасчета.ВидыЦен Цикл
			...
			Для Каждого ВыделеннаяСтрока Из Форма.Элементы.ДеревоЦен.ВыделенныеСтроки Цикл
				...
				Если СтрокаТаблицыЦен["СтараяЦенаРаспродажа" + ИмяКолонки] <> 0 Тогда
					
					Если ПараметрыРасчета.ИзменятьПоОтношениюКСтаройЦене Тогда
						СтрокаТаблицыЦен["ПроцентИзмененияРаспродажа" + ИмяКолонки] = СтрокаМассива.ПроцентИзменения;
						СтрокаТаблицыЦен[ИмяКолонки] = Окр(СтрокаТаблицыЦен["СтараяЦенаРаспродажа"+ИмяКолонки]*((СтрокаТаблицыЦен["ПроцентИзмененияРаспродажа"+ИмяКолонки]/100)+1), 2);
					Иначе
						СтрокаТаблицыЦен[ИмяКолонки] = Окр(СтрокаТаблицыЦен[ИмяКолонки]*((СтрокаМассива.ПроцентИзменения/100)+1), 2);
						СтрокаТаблицыЦен["ПроцентИзмененияРаспродажа" + ИмяКолонки] = (СтрокаТаблицыЦен[ИмяКолонки] / СтрокаТаблицыЦен["СтараяЦенаРаспродажа" + ИмяКолонки] - 1) * 100; 
					КонецЕсли;
					
				Иначе
					
					СтрокаТаблицыЦен["ПроцентИзмененияРаспродажа" + ИмяКолонки] = 0;
					Если ПараметрыРасчета.ИзменятьПоОтношениюКСтаройЦене Тогда
						СтрокаТаблицыЦен[ИмяКолонки] = 0;
					Иначе
						СтрокаТаблицыЦен[ИмяКолонки] = Окр(СтрокаТаблицыЦен[ИмяКолонки]*((СтрокаМассива.ПроцентИзменения/100)+1), 2);
				...
				СтрокаТаблицыЦен["ИзмененаВручнуюРаспродажа" + ИмяКолонки] = Истина;
				СтрокаТаблицыЦен["ИзмененаАвтоматическиРаспродажа" + ИмяКолонки] = Ложь;
			КонецЦикла;
	...
	//ВыбранныеСтрокиВидовЦен = УстановкаЦенПоЦеновымГруппамКлиентСервер.ВыбранныеСтрокиТаблицыВидовЦен(Форма);
...
Функция ПолучитьИдентификаторыВлияющихВидовЦен(Знач ТекФормула)
	РезультатИдент = Новый Массив;
	
	Пока Найти(ТекФормула,"[") Цикл
		Перв 	= Найти(ТекФормула,"[");
		Второй 	= Найти(ТекФормула,"]");
		
		ТекущийИдент 	= Сред(ТекФормула,Перв,Второй-Перв+1);
		ТекФормула 		= СтрЗаменить(ТекФормула,ТекущийИдент,"");
		
		ТекущийИдент = СтрЗаменить(ТекущийИдент,"[","");
		ТекущийИдент = СтрЗаменить(ТекущийИдент,"]","");
		РезультатИдент.Добавить(ТекущийИдент);
		
	КонецЦикла;	
	
	Возврат РезультатИдент;
КонецФункции

Функция ИзменитьЦеныПоФормуле(Форма, ПараметрыРасчета, КэшДанных = Неопределено) Экспорт
	...
	Если Не ПараметрыРасчета.ТолькоВыделенныеСтроки Тогда
		...
		Для Каждого СтрокаМассива Из ПараметрыРасчета.ВидыЦен Цикл
			...
			ИмяКолонки = ИмяКолонкиПоВидуЦены(СтрокаМассива.ВидЦены, КэшДанных);
			ИмяКолонкиРаспродажа = "Распродажа" + ИмяКолонкиПоВидуЦены(СтрокаМассива, КэшДанных);
			
			ЭлементыНоменклатура = Форма.ДеревоЦен.ПолучитьЭлементы();
			Для Каждого ЭлементНоменклатура Из ЭлементыНоменклатура Цикл
				
				Если ЭлементНоменклатура["Формула"+ИмяКолонки] <> "" Тогда
					
					Формула = ЭлементНоменклатура["Формула"+ИмяКолонки];
					
					МассивМдентификаторов = ПолучитьИдентификаторыВлияющихВидовЦен(Формула);
					
					Для Каждого ИдентВлияющейЦены из МассивМдентификаторов Цикл
						Если Найти(ИдентВлияющейЦены,"парам_") Тогда
							Идент 			= СтрЗаменить(ИдентВлияющейЦены,"парам_","");
							СсылкаПараметр 	= Справочники.Параметры.НайтиПоРеквизиту("Идентификатор",Идент);
							
							ТекЗначение = СтрЗаменить(Формат(СсылкаПараметр.Значение,"ЧГ=0"),",",".");
							
							Если СсылкаПараметр.ЗначенияПоЦеновымГруппам.Количество() Тогда
							
								НайденнаяСтрока = СсылкаПараметр.ЗначенияПоЦеновымГруппам.Найти(ЭлементНоменклатура.ЦеноваяГруппа,"ЦеноваяГруппа");
								Если НайденнаяСтрока <> Неопределено Тогда
									ТекЗначение = СтрЗаменить(Формат(НайденнаяСтрока.Значение,"ЧГ=0"),",",".");		
								КонецЕсли;							
							КонецЕсли; 
							
							Формула = СтрЗаменить(Формула, "[" + ИдентВлияющейЦены + "]", ТекЗначение);							
						Иначе
							СтрокаБазовойЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВидаЦенПоИдентификатору(
							Форма.ВыбранныеЦены,
							ИдентВлияющейЦены);
							
							//СтрокаПересчетаВалюты   = УстановкаЦенПоЦеновымГруппамКлиентСервер.СтрокаПересчетаВалюты(
							//СтрокаБазовойЦены.Валюта,
							//СтрокаМассива.ВалютаЦены,
							//ДанныеДляРасчетаВычисляемыхЦенНаКлиенте.КурсыВалют);
							
							СтрокаЗамены = "ЭлементНоменклатура."
					...
					ЗначениеЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.ОкруглитьЦену(Вычислить(Формула), СтрокаМассива);
					ЭлементНоменклатура["ПроцентИзменения" + ИмяКолонки] = 0;
					ЭлементНоменклатура[ИмяКолонки] = ЗначениеЦены;
					Если ЭлементНоменклатура["СтараяЦена" + ИмяКолонки] > 0 Тогда
						ЭлементНоменклатура["ПроцентИзменения" + ИмяКолонки] = (ЭлементНоменклатура[ИмяКолонки] / ЭлементНоменклатура["СтараяЦена" + ИмяКолонки] - 1) * 100; 
					КонецЕсли;
				КонецЕсли;
				
				Если ЭлементНоменклатура["ФормулаРаспродажа"+ИмяКолонки] <> "" Тогда
					
					Формула = ЭлементНоменклатура["ФормулаРаспродажа"+ИмяКолонки];
					...
					Для Каждого ИдентВлияющейЦены из МассивМдентификаторов Цикл
						...
						СтрокаЗамены = "ЭлементНоменклатура.Распродажа"
						+ СтрокаБазовойЦены.ИмяКолонки;
						//+ СтрокаПересчетаВалюты;
						Формула = СтрЗаменить(Формула, "[" + СтрокаБазовойЦены.Идентификатор + "]", СтрокаЗамены);
					КонецЦикла;
					...
					ЗначениеЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.ОкруглитьЦену(Вычислить(Формула), СтрокаМассива);
					ЭлементНоменклатура["ПроцентИзменения" + ИмяКолонкиРаспродажа] = 0;
					ЭлементНоменклатура[ИмяКолонкиРаспродажа] = ЗначениеЦены;
					Если ЭлементНоменклатура["СтараяЦена" + ИмяКолонкиРаспродажа] > 0 Тогда
						ЭлементНоменклатура["ПроцентИзменения" + ИмяКолонкиРаспродажа] = (ЭлементНоменклатура[ИмяКолонкиРаспродажа] / ЭлементНоменклатура["СтараяЦена" + ИмяКолонкиРаспродажа] - 1) * 100; 
					КонецЕсли;
	...
	Иначе
		...
		Для Каждого СтрокаМассива Из ПараметрыРасчета.ВидыЦен Цикл
			...
			Для Каждого ВыделеннаяСтрока Из Форма.Элементы.ДеревоЦен.ВыделенныеСтроки Цикл
				...
				Если СтрокаТаблицыЦен["Формула"+ИмяКолонки] <> "" Тогда
					
					Формула = СтрокаТаблицыЦен["Формула"+ИмяКолонки];
					...
					ЗначениеЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.ОкруглитьЦену(Вычислить(Формула), СтрокаМассива);
					СтрокаТаблицыЦен["ПроцентИзменения" + ИмяКолонки] = 0;
					СтрокаТаблицыЦен[ИмяКолонки] = ЗначениеЦены;
					Если СтрокаТаблицыЦен["СтараяЦена" + ИмяКолонки] > 0 Тогда
						СтрокаТаблицыЦен["ПроцентИзменения" + ИмяКолонки] = (СтрокаТаблицыЦен[ИмяКолонки] / СтрокаТаблицыЦен["СтараяЦена" + ИмяКолонки] - 1) * 100; 
					КонецЕсли;
				...
				Если СтрокаТаблицыЦен["ФормулаРаспродажа"+ИмяКолонки] <> "" Тогда
					
					Формула = СтрокаТаблицыЦен["ФормулаРаспродажа"+ИмяКолонки];
					...
					Для Каждого ИдентВлияющейЦены из МассивМдентификаторов Цикл
						...
						СтрокаЗамены = "СтрокаТаблицыЦен.Распродажа"
						+ СтрокаБазовойЦены.ИмяКолонки;
						//+ СтрокаПересчетаВалюты;
						Формула = СтрЗаменить(Формула, "[" + СтрокаБазовойЦены.Идентификатор + "]", СтрокаЗамены);
					КонецЦикла;
					...
					ЗначениеЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.ОкруглитьЦену(Вычислить(Формула), СтрокаМассива);
					СтрокаТаблицыЦен["ПроцентИзменения" + ИмяКолонкиРаспродажа] = 0;
					СтрокаТаблицыЦен[ИмяКолонкиРаспродажа] = ЗначениеЦены;
					Если СтрокаТаблицыЦен["СтараяЦена" + ИмяКолонкиРаспродажа] > 0 Тогда
						СтрокаТаблицыЦен["ПроцентИзменения" + ИмяКолонкиРаспродажа] = (СтрокаТаблицыЦен[ИмяКолонкиРаспродажа] / СтрокаТаблицыЦен["СтараяЦена" + ИмяКолонкиРаспродажа] - 1) * 100; 
					КонецЕсли;
...
Процедура ЗагрузитьЗначенияБазовыхЦен(Форма,
	...
	Если СтруктураПараметров.МассивСтрокВидовЦен.Количество() > 0 Тогда
		...
		Запрос = Новый Запрос("
			...
			|ИЗ
			|	&ТаблицаНоменклатуры КАК ТаблицаНоменклатуры
			|ИНДЕКСИРОВАТЬ ПО ЦеноваяГруппа
			|;
			|ВЫБРАТЬ РАЗРЕШЕННЫЕ
			|	ЦеныНоменклатурыСрезПоследних.ЦеноваяГруппа   КАК ЦеноваяГруппа
			|	ЦеныНоменклатурыСрезПоследних.ВидЦены                                                                    КАК ВидЦены,
			|	ЦеныНоменклатурыСрезПоследних.Цена + ЦеныНоменклатурыСрезПоследних.Цена * &ПроцентИзмененияЦены / 100.00 КАК Цена
			|ИЗ
			|	РегистрСведений.дп_ЦеныПоЦеновымГруппам.СрезПоследних(
			|			&ДатаДокумента,
			|			ЦеноваяГруппа В
			|					(ВЫБРАТЬ
			|						ТаблицаНоменклатуры.ЦеноваяГруппа   КАК ЦеноваяГруппа
...
Функция ТаблицаТовары(Форма, КэшДанных = Неопределено, ТолькоИзмененные = Ложь, ПоИзменениямЗаДень = Ложь) Экспорт
	...
	ТаблицаЗначений.Колонки.Добавить("ЦенаИзмененаВручнуюРаспродажа");
	
	ВыбранныеЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.ВыбранныеСтрокиТаблицыВидовЦен(Форма);
	...
	Для Каждого СтрокаТЗ Из КэшДанных.ТаблицаСоответствияНоменклатурыСтрокамДереваТоваров Цикл
		...
		Для Каждого СтрокаВидЦены Из Форма.ВыбранныеЦены Цикл
			...
			Если СтрокаВидЦены.Выбрана ИЛИ СтрокаВидЦены.Влияет Тогда
				...
				НоваяСтрока.ЦенаРаспродажа           = СтрокаДереваЦен["Распродажа"+ИмяКолонки];
				//Если Форма.ИспользоватьУпаковкиНоменклатуры Тогда
				...
				НоваяСтрока.ЦенаИзмененаВручнуюРаспродажа = СтрокаДереваЦен["ИзмененаВручнуюРаспродажа" + ИмяКолонки];
...
Процедура ЗагрузитьСтарыеЦеныЦеновыхГруппПредприятия(Форма, ТаблицаНоменклатуры, КэшДанных) Экспорт
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
	                      ...
	                      |	ВременнаяТаблицаТовары.ВидЦены КАК ВидЦены,
	                      |	ВременнаяТаблицаТовары.Цена КАК Цена,
	                      |	ВременнаяТаблицаТовары.ЦенаРаспродажа КАК ЦенаРаспродажа,
	                      |	ВременнаяТаблицаТовары.Формула КАК Формула,
	                      |	ВременнаяТаблицаТовары.ФормулаРаспродажа КАК ФормулаРаспродажа
	                      ...
	                      |	ВременнаяТаблицаТовары.ЦенаРаспродажа КАК ЦенаРаспродажа,
	                      |	ВЫБОР
	                      |		КОГДА (ВЫРАЗИТЬ(ВременнаяТаблицаТовары.Формула КАК СТРОКА(500))) = """"
	                      |			ТОГДА ВЫБОР
	                      |					КОГДА (ВЫРАЗИТЬ(ЕСТЬNULL(ВидыЦенЦеновыеГруппы.Формула, """") КАК СТРОКА(500))) = """"
	                      |						ТОГДА ФормулыЦеновыеГруппы.Формула
	                      |					ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВидыЦенЦеновыеГруппы.Формула, """") КАК СТРОКА(500))
	                      |				КОНЕЦ
	                      |		ИНАЧЕ ВЫРАЗИТЬ(ВидыЦенЦеновыеГруппы.Формула КАК СТРОКА(500))
	                      |	КОНЕЦ КАК Формула,
	                      |	ВЫБОР
	                      |		КОГДА (ВЫРАЗИТЬ(ВременнаяТаблицаТовары.ФормулаРаспродажа КАК СТРОКА(500))) = """"
	                      |			ТОГДА ВЫРАЗИТЬ(ФормулыЦеновыеГруппы.ФормулаРаспродажа КАК СТРОКА(500))
	                      |		ИНАЧЕ ВЫРАЗИТЬ(ВременнаяТаблицаТовары.ФормулаРаспродажа КАК СТРОКА(500))
	                      |	КОНЕЦ КАК ФормулаРаспродажа
	                      ...
	                      |			И ВременнаяТаблицаТовары.ЦеноваяГруппа = ВидыЦенЦеновыеГруппы.ЦеноваяГруппа
	                      |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.дп_ФормулыПоЦеновымГруппам.СрезПоследних(
	                      //|				&ДатаДокумента,
						  |				,
	                      |				(ЦеноваяГруппа, ВидЦены) В
	                      |					(ВЫБРАТЬ
	                      |						Т.ЦеноваяГруппа,
	                      |						Т.ВидЦены
	                      |					ИЗ
	                      |						ВременнаяТаблицаТовары КАК Т)) КАК ФормулыЦеновыеГруппы
	                      |		ПО ВременнаяТаблицаТовары.ВидЦены = ФормулыЦеновыеГруппы.ВидЦены
	                      |			И ВременнаяТаблицаТовары.ЦеноваяГруппа = ФормулыЦеновыеГруппы.ЦеноваяГруппа
	                      |
	                      |ИНДЕКСИРОВАТЬ ПО
	                      |	ЦеноваяГруппа,
	                      |	ВидЦены
	                      ...
	                      |////////////////////////////////////////////////////////////////////////////////
	                      |ВЫБРАТЬ
	                      |	ВременнаяТаблицаТовары.ЦеноваяГруппа,
	                      |	ВременнаяТаблицаТовары.ВидЦены,
	                      |	ВременнаяТаблицаТовары.Цена,
	                      |	ВременнаяТаблицаТовары.ЦенаРаспродажа,
	                      |	МАКСИМУМ(ВременнаяТаблицаТовары.Формула) КАК Формула,
	                      |	МАКСИМУМ(ВременнаяТаблицаТовары.ФормулаРаспродажа) КАК ФормулаРаспродажа
	                      |ПОМЕСТИТЬ Врем2
	                      |ИЗ
	                      |	ВременнаяТаблица1 КАК ВременнаяТаблицаТовары
	                      |
	                      |СГРУППИРОВАТЬ ПО
	                      |	ВременнаяТаблицаТовары.ЦеноваяГруппа,
	                      |	ВременнаяТаблицаТовары.ВидЦены,
	                      ...
	                      |	ВременнаяТаблицаТовары.Формула КАК Формула,
	                      |	ВременнаяТаблицаТовары.ФормулаРаспродажа КАК ФормулаРаспродажа,
	                      |	ЦеныНоменклатуры.Цена КАК ДействующаяЦена,
	                      |	ЦеныНоменклатуры.ЦенаРаспродажа КАК ДействующаяЦенаРаспродажа,
	                      |	ВЫБОР
	                      |		КОГДА ВременнаяТаблицаТовары.Цена <> 0
	                      |			ТОГДА 100 * ((ВременнаяТаблицаТовары.Цена - ЦеныНоменклатуры.Цена) / ЦеныНоменклатуры.Цена)
	                      |		ИНАЧЕ 0
	                      |	КОНЕЦ КАК Процент,
	                      |	ВЫБОР
	                      |		КОГДА ВременнаяТаблицаТовары.ЦенаРаспродажа <> 0
	                      |			ТОГДА 100 * ((ВременнаяТаблицаТовары.ЦенаРаспродажа - ЦеныНоменклатуры.ЦенаРаспродажа) / ЦеныНоменклатуры.ЦенаРаспродажа)
	                      |		ИНАЧЕ 0
	                      |	КОНЕЦ КАК ПроцентРаспродажа
	                      |ИЗ
	                      |	Врем2 КАК ВременнаяТаблицаТовары
	                      ...
	                      |		ПО (ЦеныНоменклатуры.ЦеноваяГруппа = ВременнаяТаблицаТовары.ЦеноваяГруппа)
	                      |			И (ЦеныНоменклатуры.ВидЦены = ВременнаяТаблицаТовары.ВидЦены)
	                      |ИТОГИ
	                      |	МАКСИМУМ(Цена),
	                      |	МАКСИМУМ(ЦенаРаспродажа),
	                      |	МАКСИМУМ(Формула),
	                      |	МАКСИМУМ(ФормулаРаспродажа),
	                      |	МАКСИМУМ(ДействующаяЦена),
	                      |	МАКСИМУМ(ДействующаяЦенаРаспродажа),
	                      |	МАКСИМУМ(Процент),
	                      |	МАКСИМУМ(ПроцентРаспродажа)
	                      |ПО
	                      |	ЦеноваяГруппа,
	                      |	ВидЦены");
	...
	Пока ВыборкаНоменклатура.Следующий() Цикл
		...
		//Пока ВыборкаХарактеристики.Следующий() Цикл
			...
			Если ЗначениеЗаполнено(ВыборкаНоменклатура.ЦеноваяГруппа) Тогда
				
				ЭлементХарактеристика = НайтиСтрокуДереваЦен(Форма, ВыборкаНоменклатура, КэшДанных);
				...
				Пока ВыборкаВидыЦен.Следующий() Цикл
					...
					Если ВыборкаВидыЦен.Цена = 0 Тогда
						ЭлементХарактеристика[ИмяКолонки] 					   = ВыборкаВидыЦен.ДействующаяЦена;
					Иначе
					...
					Если ВыборкаВидыЦен.ЦенаРаспродажа = 0 Тогда
						ЭлементХарактеристика["Распродажа"       + ИмяКолонки] 					   = ВыборкаВидыЦен.ДействующаяЦенаРаспродажа;
					Иначе
						ЭлементХарактеристика["Распродажа"       + ИмяКолонки] 					   = ВыборкаВидыЦен.ЦенаРаспродажа;
					КонецЕсли;
					ЭлементХарактеристика["СтараяЦенаРаспродажа"       + ИмяКолонки] = ВыборкаВидыЦен.ДействующаяЦенаРаспродажа;
					ЭлементХарактеристика["ПроцентИзмененияРаспродажа" + ИмяКолонки] = ВыборкаВидыЦен.ПроцентРаспродажа;
					ЭлементХарактеристика["ФормулаРаспродажа" + ИмяКолонки] 		 = ВыборкаВидыЦен.ФормулаРаспродажа;
...
Процедура ЗагрузитьСтарыеЦеныНоменклатуры(Форма, ТаблицаНоменклатуры, КэшДанных) Экспорт
	...
	ЗагрузитьСтарыеЦеныЦеновыхГруппПредприятия(Форма, ТаблицаНоменклатуры, КэшДанных);
КонецПроцедуры
...
Процедура ПоместитьСтрокуЦенВТабличнуюЧасть(Параметры, СтрокаЦен) Экспорт
	...
	Для Каждого ВидЦены Из Параметры.Форма.ВыбранныеЦены Цикл
		...
		Если ВидЦены.Выбрана Или Параметры.СохранятьБазовые И ВидЦены.Влияет Тогда
			...
			ИмяКолонки = ВидЦены.ИмяКолонки;
			ИмяКолонкиРаспродажа = "Распродажа"+ИмяКолонки;
			ЕстьКолонкаЦены = СтрокаЦен.Свойство(ИмяКолонки);
			Если ЕстьКолонкаЦены Тогда
				Цена = СтрокаЦен[ИмяКолонки];
			КонецЕсли;
			
			ЕстьКолонкаЦеныРаспродажа = СтрокаЦен.Свойство(ИмяКолонкиРаспродажа);
			Если ЕстьКолонкаЦеныРаспродажа Тогда
				ЦенаРаспродажа = СтрокаЦен[ИмяКолонкиРаспродажа];
			КонецЕсли;
			...
			НоваяСтрока.ЦеноваяГруппа   = СтрокаЦен.ЦеноваяГруппа;
			...
			Если ЕстьКолонкаЦены Тогда
				...
				НоваяСтрока.ФормулаРаспродажа = СтрокаЦен["ФормулаРаспродажа" + ИмяКолонки];
			...
			Если ЕстьКолонкаЦеныРаспродажа Тогда
				НоваяСтрока.ЦенаРаспродажа = ЦенаРаспродажа;
				Если Не ЭтоРегистрацияЦенПоставщика Тогда
					НоваяСтрока.ЦенаИзмененаВручнуюРаспродажа = СтрокаЦен["ИзмененаВручную" + ИмяКолонкиРаспродажа];
				КонецЕсли;
			КонецЕсли;
...
Процедура ПоместитьВидыЦенВТабличнуюЧасть(Форма,
	...
	МассивВыбранныхВидовЦен = УстановкаЦенПоЦеновымГруппамКлиентСервер.ВыбранныеСтрокиТаблицыВидовЦен(Форма);
...
Функция ЗагрузитьИзExcel(Форма, МассивСтруктурВидыЦен, МассивСтруктурТовары) Экспорт
	...
	Для Каждого СтруктураВидЦены Из МассивСтруктурВидыЦен Цикл
		...
		Попытка
			...
			СтрокаВидЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВидаЦен(Форма.ВыбранныеЦены, ВидЦены);
	...
	Если ПодборТоваровКлиентСервер.ЭтоФормаПрайсЛиста(Форма) Тогда
		...
		Для Каждого СтрокаТЧ Из ВидыЦен Цикл
			СтрокаВидаЦен = УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВидаЦен(Форма.ВыбранныеЦены, СтрокаТЧ.ВидЦены);
	...
	Для Каждого СтруктураТовар Из МассивСтруктурТовары Цикл
		...
		Попытка
			ЦеноваяГруппа   = Справочники.ЦеновыеГруппы.ПолучитьСсылку(Новый УникальныйИдентификатор(СтруктураТовар.ИдентификаторНоменклатура));
		...
		СтрокаДереваЦен = НайтиСтрокуДереваЦен(
			Форма,
			Новый Структура("ЦеноваяГруппа", ЦеноваяГруппа),
			КэшДанных);
		Если СтрокаДереваЦен = Неопределено Тогда
			...
			Если СтрокаДереваЦен = Неопределено Тогда
				...
				СтрокаДереваЦен.ЦеноваяГруппа = ЦеноваяГруппа;
				
				НоваяСтрока = КэшДанных.ТаблицаСоответствияНоменклатурыСтрокамДереваТоваров.Добавить();
				НоваяСтрока.ЦеноваяГруппа = ЦеноваяГруппа;
	...
	Для Каждого СтрокаТЧ Из ВидыЦен Цикл
		МассивСтрокЗависимыхЦен = ЗависимыеОтВидаЦеныВидыЦен(
			Форма,
			УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВидаЦен(Форма.ВыбранныеЦены, СтрокаТЧ.ВидЦены));
		Для Каждого СтрокаВидЦены Из МассивСтрокЗависимыхЦен Цикл
			Если ЗависимыеЦены.Найти(СтрокаВидЦены) = Неопределено
...
Функция КоэффициентыУпаковокНоменклатурыДереваТоваров(Форма) Экспорт
	...
	МассивВидовЦен = УстановкаЦенПоЦеновымГруппамКлиентСервер.ВыбранныеСтрокиТаблицыВидовЦен(Форма);
...
Процедура ЗагрузитьТабличнуюЧастьТовары(Форма, КэшДанных) Экспорт
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
	                      ...
	                      |	ВременнаяТаблицаТовары.ЦенаРаспродажа КАК ЦенаРаспродажа,
	                      |	ВременнаяТаблицаТовары.ЦенаИзмененаВручнуюРаспродажа КАК ЦенаИзмененаВручнуюРаспродажа,
	                      |	ВременнаяТаблицаТовары.Формула КАК Формула,
	                      |	ВременнаяТаблицаТовары.ФормулаРаспродажа КАК ФормулаРаспродажа
	                      |ПОМЕСТИТЬ ВременнаяТаблицаТовары
	                      |ИЗ
	                      ...
	                      |		КОГДА ВременнаяТаблицаТовары.Цена = 0
	                      |			ТОГДА ЦеныНоменклатуры.Цена
	                      |		ИНАЧЕ ВременнаяТаблицаТовары.Цена
	                      |	КОНЕЦ КАК Цена,
	                      |	ВременнаяТаблицаТовары.ЦенаИзмененаВручную КАК ЦенаИзмененаВручную,
	                      |	ВЫБОР
	                      |		КОГДА ВременнаяТаблицаТовары.ЦенаРаспродажа = 0
	                      |			ТОГДА ЦеныНоменклатуры.ЦенаРаспродажа
	                      |		ИНАЧЕ ВременнаяТаблицаТовары.ЦенаРаспродажа
	                      |	КОНЕЦ КАК ЦенаРаспродажа,
	                      |	ВременнаяТаблицаТовары.ЦенаИзмененаВручнуюРаспродажа КАК ЦенаИзмененаВручнуюРаспродажа,
	                      |	ВременнаяТаблицаТовары.Формула КАК Формула,
	                      |	ВременнаяТаблицаТовары.ФормулаРаспродажа КАК ФормулаРаспродажа,
	                      |	ЦеныНоменклатуры.Цена КАК ДействующаяЦена,
	                      ...
	                      |			ТОГДА 0
	                      |		ИНАЧЕ ВЫБОР
	                      |				КОГДА ЦеныНоменклатуры.ЦенаРаспродажа <> 0
	                      |					ТОГДА 100 * ((ВременнаяТаблицаТовары.ЦенаРаспродажа - ЦеныНоменклатуры.ЦенаРаспродажа) / ЦеныНоменклатуры.ЦенаРаспродажа)
	                      |				ИНАЧЕ 0
	                      |			КОНЕЦ
	                      |	КОНЕЦ КАК ПроцентРаспродажа
	...
	ТаблицаТоваров = Форма.Объект.ЦеновыеГруппы.Выгрузить();
...
Процедура ПоместитьЦеныВТабличнуюЧасть(Параметры) Экспорт
	...
	Если ТипЗнч(Параметры.Документы) = Тип("Массив") Тогда
		Для Каждого Документ Из Параметры.Документы Цикл
			Если Параметры.Свойство("РеквизитыНовыхДокументов") Тогда
				...
				КонецЕсли;
			КонецЕсли;
			ТабличныеЧасти.Добавить(Документ.ЦеновыеГруппы);
		КонецЦикла;
	Иначе
		Если Параметры.Свойство("РеквизитыНовыхДокументов") Тогда
			...
			КонецЕсли;
		КонецЕсли;
		ТабличныеЧасти.Добавить(Параметры.Документы.ЦеновыеГруппы);
	КонецЕсли;
	...
	ЭлементыЦеноваяГруппа = Параметры.Форма.ДеревоЦен.ПолучитьЭлементы();
	Для Каждого ТекЭлементЦеноваяГруппа Из ЭлементыЦеноваяГруппа Цикл
		
		Если ТолькоИзмененные Тогда
			ЦеныИзменены = ЕстьИзмененияЦенВСтроке(ТекЭлементЦеноваяГруппа, ВидыЦен);
			Если ЦеныИзменены Тогда
				КонтрольКоличестваСтрок(Параметры);
				ПоместитьСтрокуЦенВТабличнуюЧасть(Параметры, ТекЭлементЦеноваяГруппа);
			КонецЕсли;
		Иначе
			КонтрольКоличестваСтрок(Параметры);
			ПоместитьСтрокуЦенВТабличнуюЧасть(Параметры, ТекЭлементЦеноваяГруппа);
...
Функция ЗависимыеОтВидаЦеныВидыЦен(Форма, СтрокаВидЦены) Экспорт
	...
	Для Каждого ЗависимаяЦена Из СтрокаВидЦены.ЗависимыеЦены Цикл
		СтрокаЗависимойЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВидаЦен(Форма.ВыбранныеЦены, ЗависимаяЦена.Значение);
...
Функция ЗаполненыОбязательныеПараметрыСхемКомпоновкиДанных(Форма, СообщатьПользователюОбОшибках = Истина) Экспорт
	...
	Если СообщатьПользователюОбОшибках Тогда
		Для Каждого СтруктураОшибки Из Ошибки Цикл
			СтрокаВидЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВидаЦен(Форма.ВыбранныеЦены, СтруктураОшибки.ВидЦены);
...
Процедура ПроверитьКорректностьЗаполненияДокумента(Форма, Отказ) Экспорт
	...
	//			Форма.Объект, ДеревоЦенДляПроверки, УстановкаЦенПоЦеновымГруппамКлиентСервер.ВыбранныеВидыЦен(Форма), Отказ);
	//	КонецЕсли;
	//КонецЕсли;
		...
		Для Каждого ВидЦены Из Форма.ВыбранныеЦены Цикл
			...
			Если ВидЦены.Выбрана Тогда
				...
				Для Каждого ВлияющаяЦена Из ВидЦены.ВлияющиеЦены Цикл
					СтрокаВыбраннойЦены        = УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВидаЦен(Форма.ВыбранныеЦены, ВлияющаяЦена.Значение);
	...
	Если ТаблицаНоменклатуры.Количество() > 0 Тогда
		...
		Если СтрокаВидЦены.СпособЗаданияЦены = Перечисления.СпособыЗаданияЦен.ЗаполнятьПоДаннымИБ
			...
			Если Ценообразование.ПроверитьСхемуКомпоновкиДанных(СхемаКомпоновкиДанных, СтрЗаменить(НСтр("ru='Вид цены ""%ВидЦены%""'"), "%ВидЦены%", СтрокаВидЦены.Ссылка)) Тогда
				...
				ВнешниеНаборыДанных.Вставить("ТаблицаНоменклатуры", ТаблицаНоменклатуры.Скопировать(, "ЦеноваяГруппа"));
...
Процедура ПрименитьОкруглениеКРучнымЦенам(Форма, ТаблицаНоменклатуры, ВидыЦен, КэшДанных)
	...
	Для Каждого СтрокаТаблицыНоменклатуры Из ТаблицаНоменклатуры Цикл
		...
		Для Каждого СтрокаВидЦены Из ВидыЦен Цикл
			ИмяКолонки = СтрокаВидЦены.ИмяКолонки;
			СтрокаТаблицыЦен[ИмяКолонки] = УстановкаЦенПоЦеновымГруппамКлиентСервер.ОкруглитьЦену(СтрокаТаблицыЦен[ИмяКолонки], СтрокаВидЦены);
		КонецЦикла;
...
Процедура ЗагрузитьЦеныИзТаблицыЗначений(Форма,
	...
	Для Каждого СтрокаИсточник Из Таблица Цикл
		...
		Если СтрокаЗагружаемыйВидЦены = Неопределено Тогда
			СтрокаВидЦены = УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВидаЦен(Форма.ВыбранныеЦены, СтрокаИсточник.ВидЦены);
		Иначе
		...
		Если (СтрокаТаблицыЦен[ИмяКолонки] = 0 Или Не СтруктураПараметров.ТолькоНезаполненные) И СтрокаИсточник.Цена <> Null Тогда
				...
				Если СоответствиеКоэффициентовУпаковокНоменклатуры <> Неопределено Тогда
					...
					Если ЗначениеЗаполнено(СтрокаИсточник.Коэффициент)
						...
						Если ЗначениеЗаполнено(ТекущаяУпаковка) Тогда
							...
							РезультатПоиска = УстановкаЦенПоЦеновымГруппамКлиентСервер.ПолучитьКоэффициентУпаковкиНоменклатуры(СоответствиеКоэффициентовУпаковокНоменклатуры, 
			...
			Если СтруктураПараметров.ПрименитьОкругление Тогда
				Цена = УстановкаЦенПоЦеновымГруппамКлиентСервер.ОкруглитьЦену(Цена, СтрокаВидЦены);
			КонецЕсли;
...
Процедура ЗагрузитьТоварыВДеревоЦен(Форма, ВыборкаНоменклатура, КэшДанных)
	...
	Пока ВыборкаНоменклатура.Следующий() Цикл
		...
		ЭлементНоменклатура["Распродажа"+        ИмяКолонки] = ВыборкаНоменклатура.ЦенаРаспродажа;
		ЭлементНоменклатура["СтараяЦенаРаспродажа"       + ИмяКолонки] = ВыборкаНоменклатура.ДействующаяЦенаРаспродажа;
		ЭлементНоменклатура["ПроцентИзмененияРаспродажа" + ИмяКолонки] = ВыборкаНоменклатура.ПроцентРаспродажа;
		ЭлементНоменклатура["ИзмененаВручнуюРаспродажа"  + ИмяКолонки] = ВыборкаНоменклатура.ЦенаИзмененаВручнуюРаспродажа;
		ЭлементНоменклатура["ФормулаРаспродажа"  + ИмяКолонки] 			= ВыборкаНоменклатура.ФормулаРаспродажа;
	КонецЦикла;
...
Функция ПересчитатьВалюту(ВалютаИсточник, ВалютаНазначение, Цена, СоответствиеВалют)
	...
	Если ВалютаИсточник <> ВалютаНазначение Тогда
		...
		СтрокаВалютыИсточника  = УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВалюты(СоответствиеВалют, ВалютаИсточник);
		СтрокаВалютыНазначения = УстановкаЦенПоЦеновымГруппамКлиентСервер.НайтиСтрокуВалюты(СоответствиеВалют, ВалютаНазначение);
...
Процедура ТаблицаСоответствия(Форма, КэшДанных)
	...
	КэшДанных.ТаблицаСоответствияНоменклатурыСтрокамДереваТоваров.Индексы.Добавить("ЦеноваяГруппа");
