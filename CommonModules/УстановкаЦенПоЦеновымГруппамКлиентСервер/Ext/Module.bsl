...
Функция НайтиСтрокуВидаЦенПоИдентификатору(ВыбранныеЦены, Идентификатор) Экспорт
	
	Возврат ВыбранныеЦены.НайтиСтроки(Новый Структура("Идентификатор", Идентификатор))[0];
